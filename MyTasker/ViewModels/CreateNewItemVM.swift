...
//    @Published var showSuccessAlert = false // New property to show success alert
//
//    
//    @Published var title = ""
...
//        //date is initialised to current date  hour and seconds, we get into time zone complexity
//        //so we are sub 86400 seconds (current date sub 24 hours)
